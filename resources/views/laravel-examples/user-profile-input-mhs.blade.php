                            ...
                            <div class="form-group table-responsive">
                                <table align="center" cellpadding="8" style="border-collapse: collapse; width: 100%;">
                                    <tr>
                                        ...
                                        <td>Nama Lengkap</td>
                                        <td>
                                            <input class="form-control" type="text" placeholder="Nama Lengkap" id="user-name" name="name">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>NIM</td>
                                        <td>
                                            <input class="form-control" type="text" placeholder="NIM" id="user-nim" name="nim">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Email</td>
                                    ...
                                    <tr>
                                        <td>Tanggal Lahir</td>
                                        <td>
                                            <input class="form-control" type="date" placeholder="" id="user-birthdate" name="tanggal_lahir">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Agama</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input class="form-control" type="text" placeholder="Status Keaktifan" id="user-activity" name="status_keaktifan" disabled>
                                        </td>
                                    </tr>
                                </table>
                            </div>
