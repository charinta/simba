                                ...
                                <div class="form-group table-responsive">
                                    <table align="center" cellpadding="9" style="border-collapse: collapse; width: 100%;">
                                        <tr>
                                            ...
                                            <td>Nama Lengkap</td>
                                            <td>
                                                <input class="form-control" type="text" placeholder="Nama Lengkap" id="user-name" name="name" value="{{ $mahasiswa->name }}">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>NIM</td>
                                        ...
                                        <tr>
                                            <td>Foto</td>
                                            <td>
                                                <input class="form-control" type="file" accept="image/*" id="user-photo" name="photo" onchange="previewImage(event)">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Tanggal Lahir</td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select class="form-select" id="user-activity" name="status_keaktifan">
                                                    ...
                                                    <option value="Aktif" {{ $mahasiswa->status_keaktifan == 'Aktif' ? 'selected' : '' }}>Aktif</option>
                                                    <option value="Cuti" {{ $mahasiswa->status_keaktifan == 'Cuti' ? 'selected' : '' }}>Cuti</option>
                                                    <option value="DO Administrasi" {{ $mahasiswa->status_keaktifan == 'DO Administrasi' ? 'selected' : '' }}>DO Administrasi</option>
                                                    <option value="Tanpa Keterangan" {{ $mahasiswa->status_keaktifan == 'Tanpa Keterangan' ? 'selected' : '' }}>Tanpa Keterangan</option>
                                                </select>
                                            </td>
                                        </tr>
                                        <tr>
